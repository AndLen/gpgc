 ...
 */
public class LocumMulFeatureNode extends ERC {
    private int val;
    ...
    public boolean nodeEquals(GPNode node) {
        if (node instanceof LocumMulFeatureNode) {
            LocumMulFeatureNode fvN = (LocumMulFeatureNode) node;
            return fvN.val == val;
        } else return false;
    }
    ...
    public void eval(EvolutionState state, int thread, GPData input, ADFStack stack, GPIndividual individual, Problem problem) {
        ...
        doubleDataPair.val = locumProblem.instance1.getFeatureValue(this.val) * locumProblem.instance2.getFeatureValue(this.val);
